...
<body class="bg-gray-100 min-h-screen">
        ...
        <div class="px-3 py-3 lg:px-5 lg:pl-3">
            <div class="flex items-center justify-between">
                <div class="flex items-center justify-start">
                    ...
                    <a href="client-dashboard.php" class="text-xl font-bold flex items-center lg:ml-2.5">
                    ...
                    <div class="flex items-center ml-3">
                        ...
                        <div class="hidden z-50 my-4 text-base list-none bg-white rounded divide-y divide-gray-100 shadow" id="dropdown">
                            ...
                            <ul class="py-1" aria-labelledby="dropdown">
                                <li>
                                    <a href="client-profile.php" class="block py-2 px-4 text-sm text-gray-700 hover:bg-gray-100">Profile</a>
                                </li>
                                <li>
    ...
    <div class="pt-16 lg:ml-64">
        <div class="p-4">
                            ...
                            <a href="client-support.php" class="text-base text-gray-900 font-normal
