...
if(isset($_GET['search']) && !empty($_GET['search'])) {
    ...
    $messages = $message_obj->getSentMessagesByUser($user_id);
}
...
// Set page title
$page_title = "Sent Messages - Legal Case Management System";
...
<div class="container mx-auto px-4 py-6">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-3xl font-semibold text-gray-800">Sent Messages</h1>
        ...
        <div class="bg-white rounded-lg shadow overflow-hidden">
            ...
            <div class="p-4">
                <ul class="space-y-2">
                    ...
                    <li>
                        <a href="advocate-messages-sent.php" class="flex items-center px-3 py-2 rounded-lg bg-blue-50 text-blue-700 font-medium">
            ...
            <div class="divide-y divide-gray-200">
                                ...
                                <div class="flex items-center justify-between mb-2">
                                    <div class="flex items-center">
                                        <div class="w-10 h-10 rounded-full overflow-hidden bg-gray-200 flex-shrink-0">
                                            <?php if(!empty($message['recipient_profile_image'])): ?>
                                                <img src="../uploads/profile/<?php echo $message['recipient_profile_image']; ?>" alt="Recipient" class="w-full h-full object-cover">
                                            <?php else: ?>
                ...
                <?php else: ?>
                    <div class="p-8 text-center">
                        ...
                        <h3 class="text-lg font-medium text-gray-900 mb-1">No sent messages found</h3>
