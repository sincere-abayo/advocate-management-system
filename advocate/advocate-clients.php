...
// Get all clients - for single advocate system
                        ...
                        <?php while($client = $clients->fetch(PDO::FETCH_ASSOC)): ?>
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                    <?php 
                                    // Count cases for this client using a direct query
                                    $query = "SELECT COUNT(*) as total FROM cases WHERE client_id = ?";
                                    $stmt = $db->prepare($query);
                                    $stmt->bindParam(1, $client['id']);
                                    $stmt->execute();
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <a href="advocate-client-view.php?id=<?php echo $client['id']; ?>" class="text-indigo-600 hover:text-indigo-900 mr-3">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                    <a href="advocate-client-cases.php?id=<?php echo $client['id']; ?>" class="text-blue-600 hover:text-blue-900">
