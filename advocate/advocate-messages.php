...
if(isset($_GET['search']) && !empty($_GET['search'])) {
    ...
    $messages = $message_obj->getMessagesByUser($user_id);
}
...
// Set page title
$page_title = "Messages - Legal Case Management System";
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <div class="bg-white rounded-lg shadow overflow-hidden">
            ...
            <div class="p-4">
                <ul class="space-y-2">
                    <li>
                        <a href="advocate-messages.php" class="flex items-center justify-between px-3 py-2 rounded-lg bg-blue-50 text-blue-700 font-medium">
                    ...
                    <li>
                        <a href="advocate-messages-starred.php" class="flex items-center px-3 py-2 rounded-lg hover:bg-gray-100 text-gray-700">
            ...
            <div class="divide-y divide-gray-200">
                <?php if($messages && $messages->rowCount() > 0): ?>
                    <?php while($message = $messages->fetch(PDO::FETCH_ASSOC)): ?>
                        ...
                        ?>
                        <div class="p-4 hover:bg-gray-50 transition-colors duration-150 <?php echo $is_unread ? 'bg-blue-50' : ''; ?>">
                            <a href="advocate-message-view.php?id=<?php echo $message['id']; ?>" class="block">
                                <div class="flex items-center justify-between mb-2">
                                    <div class="flex items-center">
                                        <div class="w-10 h-10 rounded-full overflow-hidden bg-gray-200 flex-shrink-0">
                                            <?php if(!empty($message['sender_profile_image'])): ?>
                                                <img src="../uploads/profile/<?php echo $message['sender_profile_image']; ?>" alt="Sender" class="w-full h-full object-cover">
                                            <?php else: ?>
                                        ...
                                        <div class="ml-3">
                                            <h3 class="text-sm font-semibold text-gray-900 <?php echo $is_unread ? 'font-bold' : ''; ?>">
                                ...
                                <h4 class="text-sm font-medium text-gray-900 mb-1 <?php echo $is_unread ? 'font-bold' : ''; ?>">
                            ...
                            <div class="flex justify-end mt-2 space-x-2">
                                <a href="advocate-message-reply.php?id=<?php echo $message['id']; ?>" class="text-blue-600 hover:text-blue-800 text-sm">
                                    <i class="fas fa-reply mr-1"></i>Reply
                                </a>
                                <a href="#" onclick="toggleStar(<?php echo $message['id']; ?>, <?php echo $is_starred ? 'false' : 'true'; ?>); return false;" class="text-gray-600 hover:text-yellow-500 text-sm">
                                    <i class="<?php echo $is_starred ? 'fas' : 'far'; ?> fa-star mr-1"></i><?php echo $is_starred ? 'Unstar' : 'Star'; ?>
                                </a>
                ...
                <?php else: ?>
                    <div class="p-8 text-center">
                        ...
                        <a href="advocate-message-compose.php" class="mt-4 inline-block bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-lg text-sm font-medium">
                            <i class="fas fa-pen mr-2"></i>Compose New Message
                        </a>
                    </div>
                <?php endif; ?>
            </div>
