...
$checkStmt->bind_param("iiiiii", $userId, $userId, $userId, $conversationId, $userId, $userId);
$checkStmt->execute();
    ...
    <div class="bg-white rounded-lg shadow-md overflow-hidden mb-6">
            ...
            <?php else: ?>
                ...
                ?>
                    ...
                    <div class="mb-4 <?php echo $isSentByMe ? 'text-right' : ''; ?>">
                        <div class="inline-block max-w-3/4 px-4 py-2 rounded-lg <?php echo $isSentByMe ? 'bg-blue-100 text-blue-800' : 'bg-gray-100 text-gray-800'; ?>">
        ...
        <div class="p-4 border-t border-gray-200">
            <form method="POST" action="" id="messageForm">
                <div class="flex">
                    <textarea name="message" id="message" rows="2" class="form-textarea flex-grow mr-2 resize-none" placeholder="Type your message..." required></textarea>
                    <button type="submit" class="bg-blue-600 hover:bg-blue-700 text-white font-medium py-2 px-4 rounded-lg self-end">
