...
if(isset($_GET['search']) && !empty($_GET['search'])) {
    ...
    // For trash, we need a special search function that includes deleted messages
    // For now, we'll just show all trash items
    $messages = $message_obj->getTrashMessagesByUser($user_id);
} else {
    // Get trash messages for the current user
    $messages = $message_obj->getTrashMessagesByUser($user_id);
}
...
// Set page title
$page_title = "Trash - Legal Case Management System";
...
<div class="container mx-auto px-4 py-6">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-3xl font-semibold text-gray-800">Trash</h1>
        ...
        <div class="bg-white rounded-lg shadow overflow-hidden">
            ...
            <div class="p-4">
                <ul class="space-y-2">
                    ...
                    <li>
                        <a href="advocate-messages-trash.php" class="flex items-center px-3 py-2 rounded-lg bg-blue-50 text-blue-700 font-medium">
                    ...
                    <?php while($message = $messages->fetch(PDO::FETCH_ASSOC)): ?>
                        ...
                        <div class="p-4 hover:bg-gray-50 transition-colors duration-150">
                            ...
                            <div class="flex justify-end mt-2 space-x-2">
                                <a href="advocate-message-restore.php?id=<?php echo $message['id']; ?>" class="text-blue-600 hover:text-blue-800 text-sm">
                                    <i class="fas fa-trash-restore mr-1"></i>Restore
                                </a>
                                <a href="#" onclick="confirmPermanentDelete(<?php echo $message['id']; ?>); return false;" class="text-red-600 hover:text-red-800 text-sm">
                    ...
                    <div class="p-8 text-center">
                        ...
                        <p class="text-gray-500">
                            ...
                            if(!empty($search_term)) {
                                ...
                                echo "No deleted messages found.";
                            }
                            ?>
                        </p>
...
function confirmPermanentDelete(id) {
    if(confirm('Are you sure you want to permanently delete this message? This action cannot be undone.')) {
        window.location.href = 'advocate-message-permanent-delete.php?id=' + id;
    }
}
</script>
