...
// Get client data
$clientData = getClientData($_SESSION['user_id']);
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <div class="relative" x-data="{ open: false }">
                            <button @click="open = !open" class="text-gray-500 focus:outline-none relative">
                                ...
                                <span class="absolute -top-1 -right-1 bg-red-500 text-white text-xs rounded-full h-5 w-5 flex items-center justify-center"><?php echo $unreadNotifications; ?></span>
                                <?php endif; ?>
                            </button>
                            
                            <div x-show="open" @click.away="open = false" class="absolute right-0 mt-2 w-80 bg-white rounded-lg shadow-lg py-2 z-20" style="display: none;">
                                <div class="px-4 py-2 border-b">
                                    <div class="flex justify-between items-center">
                                        <h3 class="text-sm font-semibold text-gray-700">Notifications</h3>
                                        <a href="<?= $path_url ?>client/notifications.php" class="text-xs text-blue-600 hover:underline">View All</a>
                                    </div>
                                </div>
                                ...
                                <div class="max-h-64 overflow-y-auto">
                                    ...
                                    <div class="px-4 py-3 hover:bg-gray-50 border-b">
                                        <p class="text-sm font-medium text-gray-800">Case update</p>
                                        <p class="text-xs text-gray-500">Your case status has been updated</p>
                                        <p class="text-xs text-gray-400 mt-1">2 hours ago</p>
                                    </div>
                                    
                                    <div class="px-4 py-3 hover:bg-gray-50">
                                        <p class="text-sm font-medium text-gray-800">New document</p>
                                        <p class="text-xs text-gray-500">A new document has been uploaded to your case</p>
                        ...
                        <div class="relative" x-data="{ open: false }">
                            <button @click="open = !open" class="flex items-center space-x-2 focus:outline-none">
                                ...
                                <span class="hidden md:inline-block text-sm font-medium text-gray-700"><?php echo $_SESSION['full_name'] ?? 'Client'; ?></span>
                            ...
                            <div x-show="open" @click.away="open = false" class="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg py-2 z-20" style="display: none;">
                                <a href="<?= $path_url ?>client/profile.php" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                                    <i class="fas fa-user mr-2"></i> My Profile
                                </a>
                                <a href="<?= $path_url ?>client/settings.php" class="hidden block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
