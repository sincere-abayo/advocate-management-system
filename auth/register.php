...
if ($userType === 'advocate') {
    $stmt = $conn->prepare("INSERT INTO advocate_profiles (user_id) VALUES (?)");
        ...
        <div class="max-w-2xl mx-auto">
            ...
            <?php if ($success): ?>
                <div class="bg-green-100 border-l-4 border-green-500 text-green-700 p-4 mb-6" role="alert">
                    ...
                    <p>A verification email has been sent to your email address. Please check your inbox and follow the instructions to verify your account.</p>
                ...
                <div class="bg-white rounded-lg shadow-lg p-8">
                    ...
                    <?php endif; ?>
                        ...
                        <div>
                            ...
                            <p class="text-gray-500 text-sm mt-1">3-20 characters, letters, numbers, and underscores only</p>
                        ...
                        <div class="bg-gray-50 p-5 rounded-lg border border-gray-200">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div class="border rounded-lg p-4 cursor-pointer user-type-option hover:border-blue-400 hover:bg-blue-50 transition duration-200 <?php echo (isset($_POST['user_type']) && $_POST['user_type'] === 'client') ? 'border-blue-500 bg-blue-50' : 'border-gray-200 bg-white'; ?>" data-value="client">
                                    <input type="radio" id="user_type_client" name="user_type" value="client" class="hidden" <?php echo (isset($_POST['user_type']) && $_POST['user_type'] === 'client') ? 'checked' : ''; ?>>
                                    <label for="user_type_client" class="flex items-center cursor-pointer">
                                        <div class="w-6 h-6 rounded-full border border-gray-300 flex items-center justify-center mr-3 radio-circle">
                                            <div class="w-4 h-4 rounded-full bg-blue-500 <?php echo (isset($_POST['user_type']) && $_POST['user_type'] === 'client') ? '' : 'hidden'; ?> radio-dot"></div>
                                        </div>
                                        <div>
                                ...
                                <div class="border rounded-lg p-4 cursor-pointer user-type-option hover:border-blue-400 hover:bg-blue-50 transition duration-200 <?php echo (isset($_POST['user_type']) && $_POST['user_type'] === 'advocate') ? 'border-blue-500 bg-blue-50' : 'border-gray-200 bg-white'; ?>" data-value="advocate">
                                    <input type="radio" id="user_type_advocate" name="user_type" value="advocate" class="hidden" <?php echo (isset($_POST['user_type']) && $_POST['user_type'] === 'advocate') ? 'checked' : ''; ?>>
                                    <label for="user_type_advocate" class="flex items-center cursor-pointer">
                                        <div class="w-6 h-6 rounded-full border border-gray-300 flex items-center justify-center mr-3 radio-circle">
                                            <div class="w-4 h-4 rounded-full bg-blue-500 <?php echo (isset($_POST['user_type']) && $_POST['user_type'] === 'advocate') ? '' : 'hidden'; ?> radio-dot"></div>
                                        </div>
                                        <div>
                        ...
                        <div class="bg-gray-50 p-5 rounded-lg border border-gray-200">
                            <div class="flex items-center">
                                <input type="checkbox" id="terms" name="terms" class="h-5 w-5 text-blue-600 focus:ring-blue-500 border-gray-300 rounded" required>
                                <label for="terms" class="ml-3 text-gray-600">
                                    I agree to the <a href="/terms.php" class="text-blue-600 hover:text-blue-800 hover:underline">Terms of Service</a> and <a href="/privacy-policy.php" class="text-blue-600 hover:text-blue-800 hover:underline">Privacy Policy</a>
                                </label>
                            </div>
                        </div>
