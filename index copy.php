...
<head>
    ...
    <title>LegalEase - Personal Legal Practice Management System</title>
            ...
            <div class="lg:flex lg:items-center lg:justify-between">
                <div class="lg:w-1/2" data-aos="fade-right" data-aos-duration="1000">
                    ...
                    <p class="mt-3 max-w-md mx-auto text-lg text-gray-500 sm:text-xl md:mt-5 md:max-w-3xl">
                        A personal case management system designed for individual advocates. Organize your cases, clients, and documents in one place.
                    </p>
                ...
                <div class="mt-10 lg:mt-0 lg:w-1/2" data-aos="fade-left" data-aos-duration="1000">
                    <img class="rounded-lg shadow-xl" src="assets/img/dashboard-preview.png" alt="Dashboard Preview" onerror="this.src='https://via.placeholder.com/600x400?text=Personal+Advocate+Dashboard'">
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-2 gap-4 md:grid-cols-4 md:gap-8">
                <div class="bg-gray-50 rounded-lg p-6 text-center" data-aos="zoom-in" data-aos-delay="100">
                    ...
                    <div class="text-gray-600">Less Paperwork</div>
                </div>
                <div class="bg-gray-50 rounded-lg p-6 text-center" data-aos="zoom-in" data-aos-delay="200">
                    <div class="text-indigo-600 text-4xl font-bold mb-2">25%</div>
                ...
                <div class="bg-gray-50 rounded-lg p-6 text-center" data-aos="zoom-in" data-aos-delay="300">
                    <div class="text-indigo-600 text-4xl font-bold mb-2">100%</div>
                    <div class="text-gray-600">Case Visibility</div>
                </div>
                <div class="bg-gray-50 rounded-lg p-6 text-center" data-aos="zoom-in" data-aos-delay="400">
                    ...
                    <div class="text-gray-600">Access Anywhere</div>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                ...
                <p class="mt-4 text-lg text-gray-600" data-aos="fade-up" data-aos-delay="100">
                    Designed specifically for individual advocates and small practices
                </p>
            </div>
            ...
            <div class="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
                ...
                <div class="bg-white rounded-lg shadow-lg overflow-hidden feature-card" data-aos="fade-up" data-aos-delay="150">
                    <div class="p-6">
                        ...
                        <p class="text-gray-600">
                            Track all your cases in one place. Monitor status, deadlines, and important details with ease.
                        </p>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-lg overflow-hidden feature-card" data-aos="fade-up" data-aos-delay="200">
                    <div class="p-6">
                        ...
                        <p class="text-gray-600">
                            Give your clients secure access to their case information and documents.
                        </p>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-lg overflow-hidden feature-card" data-aos="fade-up" data-aos-delay="250">
                    <div class="p-6">
                        ...
                        <p class="text-gray-600">
                            Store and organize all your legal documents securely in one place.
                        </p>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-lg overflow-hidden feature-card" data-aos="fade-up" data-aos-delay="300">
                    <div class="p-6">
                        ...
                        <p class="text-gray-600">
                            Never miss a court date or appointment with integrated calendar and reminders.
                        </p>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-lg overflow-hidden feature-card" data-aos="fade-up" data-aos-delay="350">
                    <div class="p-6">
                        ...
                        <h3 class="text-xl font-semibold text-gray-900 mb-2">Client Communication</h3>
                        <p class="text-gray-600">
                            Keep all client communications organized and in one secure location.
                        </p>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-lg overflow-hidden feature-card" data-aos="fade-up" data-aos-delay="400">
                    <div class="p-6">
                        ...
                        <p class="text-gray-600">
                            Create and track tasks for each case to ensure nothing falls through the cracks.
                        </p>
                    </div>
                </div>
            </div>
    ...
    <section id="how-it-works" class="py-16 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                ...
                <p class="mt-4 text-lg text-gray-600" data-aos="fade-up" data-aos-delay="100">
                    Get started in minutes and transform your practice
                </p>
            </div>
            ...
            <div class="relative">
                ...
                <div class="relative" data-aos="fade-left">
                    <div class="md:flex md:items-center">
                        ...
                        <div class="md:w-1/2 pl-8 md:pr-8 md:pl-0 md:text-right mt-4 md:mt-0 order-first">
                            <h3 class="text-xl font-semibold text-gray-900 mb-2">Manage Your Practice</h3>
                            <p class="text-gray-600">
    ...
    <section id="testimonials" class="py-16 bg-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                ...
                <p class="mt-4 text-lg text-gray-600" data-aos="fade-up" data-aos-delay="100">
                    Trusted by solo practitioners and small law firms
                </p>
            </div>
            ...
            <div class="grid grid-cols-1 gap-8 md:grid-cols-3">
                    ...
                    <p class="text-gray-600 italic">
                        "As a solo practitioner, keeping track of all my cases was overwhelming. This system has completely transformed how I manage my practice. I'm saving hours each week on administrative tasks."
                    </p>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-lg p-6 testimonial-card" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <p class="text-gray-600 italic">
                        "The document management system is exceptional. I can access everything I need from anywhere, and sharing with clients is seamless and secure. Perfect for my small practice."
                    </p>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-lg p-6 testimonial-card" data-aos="fade-up" data-aos-delay="250">
                    ...
                    <p class="text-gray-600 italic">
                        "The case tracking features have been invaluable for my immigration practice. I can keep clients updated on their case status in real-time without hiring additional staff."
                    </p>
                </div>
            </div>
        </div>
            ...
            <div class="grid grid-cols-1 gap-8 md:grid-cols-3">
                ...
                <div class="bg-white rounded-lg shadow-lg overflow-hidden pricing-card border border-gray-200" data-aos="fade-up" data-aos-delay="150">
                    <div class="p-6 border-b border-gray-200">
                        ...
                        <p class="text-gray-600 mt-1">For new solo practitioners</p>
                        <div class="mt-4">
                ...
                <div class="bg-white rounded-lg shadow-xl overflow-hidden pricing-card border-2 border-indigo-500 transform scale-105 z-10" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div class="p-6 border-b border-gray-200">
                        ...
                        <p class="text-gray-600 mt-1">For established practitioners</p>
                        <div class="mt-4">
                    ...
                    <div class="p-6">
                        <ul class="space-y-4">
                            <li class="flex items-center">
                                <i class="fas fa-check text-green-500 mr-3"></i>
                                <span class="text-gray-600">Up to 75 active cases</span>
                            </li>
                            <li class="flex items-center">
                                <i class="fas fa-check text-green-500 mr-3"></i>
                            ...
                            <li class="flex items-center">
                                <i class="fas fa-check text-green-500 mr-3"></i>
                                <span class="text-gray-600">Calendar integrations</span>
                            </li>
                        </ul>
                        <div class="mt-8">
                            <a href="register.php" class="block w-full bg-indigo-600 hover:bg-indigo-700 text-white font-medium py-3 px-4 rounded-md text-center">
                ...
                <div class="bg-white rounded-lg shadow-lg overflow-hidden pricing-card border border-gray-200" data-aos="fade-up" data-aos-delay="250">
                    <div class="p-6 border-b border-gray-200">
                        ...
                        <p class="text-gray-600 mt-1">For busy practitioners</p>
                        <div class="mt-4">
            ...
            <div class="max-w-3xl mx-auto divide-y divide-gray-200">
                ...
                <div class="py-6" data-aos="fade-up" data-aos-delay="300">
                    <details class="group">
                        ...
                        <p class="text-gray-600 mt-3 group-open:animate-fadeIn">
                            Yes, our platform is highly customizable. You can configure case types, document categories, custom fields, and workflows to match your practice's specific needs. Premium plans include additional customization options, including white-labeling.
                        </p>
                    </details>
                </div>
                ...
                <div class="py-6" data-aos="fade-up" data-aos-delay="350">
                    <details class="group">
                        ...
                        <p class="text-gray-600 mt-3 group-open:animate-fadeIn">
                            All plans include email support. Professional and Premium plans include phone support with priority response times. We also provide comprehensive documentation, video tutorials, and regular webinars to help you get the most out of the platform.
                        </p>
                    </details>
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                <div>
                    ...
                    <p class="mt-4 text-gray-400">
                        Streamlining legal practice management for individual advocates.
                    </p>
